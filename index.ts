...
import { getDayOfTheYear, sortImagesByName, todayIsHerBirthDayInBuenosAires, todayIsOurAnniversary } from './src/utils/utils'
import { anniversaryText, availableTexts, birthdayText } from './src/assets/messagesToSend'
